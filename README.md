...
- **Tech:** Python, OpenAI API, Twilio, n8n, FastAPI
...
Custom chatbot solution with RAG (Retrieval-Augmented Generation) for businesses
- **Tech:** Python, LangChain, OpenAI, Vector DB
- **Features:** Context-aware responses, multi-language support, analytics dashboard
...
- 📚 Continuous learning: LLMs, Prompt Engineering, MLOps
